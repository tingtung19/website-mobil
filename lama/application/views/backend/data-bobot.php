			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Kelola Bobot Aalternatif terhadap Kriteria</h2>
						
						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Daftar Alternatif</div>
							<div class="panel-body">
								<form  method="post" class="form-horizontal" action="<?php echo base_url('spk/data_detail_kriteria'); ?>" >
											...
											<select class="form-control" name="id_kriteria">
												<?php
													foreach ($data_mobil as $dm) {
														echo "<option value='$dm[id_mobil]'>$dm[nama_mobil]</option>";
													}
												?>
											</select>
										</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label">Detail Kriteria</label>
										<div class="col-sm-9">
											<select class="form-control" name="id_detail_kriteria">
												<?php
													foreach ($data_detail_kriteria as $ddk) {
														echo "<option value='$ddk[id_detail_kriteria]'>$ddk[nama_detail_kriteria]</option>";
													}
												?>
											</select>
										</div>
									...
									<div class="form-group">
										<div class="col-sm-9 col-sm-offset-3">
											<button class="btn btn-sm btn-primary" type="submit" name="submit"><span class="fa fa-plus-circle"></span> Tambah Bobot Kriteria</button>
										</div>
									</div>
								</form>
