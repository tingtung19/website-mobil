      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <li><a href="<?php echo base_url('about_us') ;?>">Tentang Kami</a></li>
			...
			<li><a href="<?php echo base_url('car_listing') ;?>">Daftar Mobil</a></li>
          </ul>
        </div>
        <div class="col-md-4">
          <h6></h6>
      ...
      <div class="row">
        <div class="col-md-6 col-md-push-6 text-right">
          <div class="footer_widget">
            <p>Selalu terhubung dengan kami di :</p>
            <ul>
        ...
        <div class="col-md-6 col-md-pull-6">
          <p class="copy-right">Copyright &copy; <?php echo date('Y')." ".$data_profil['nama_profil'] ;?>. All Rights Reserved</p>
        </div>
      </div>
    </div>
  </div>
